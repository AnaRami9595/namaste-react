const restList = [
    {
        ...
        data: {
            ...
            name: "Paratha Box",
            avgRating: 4.8,
            cuisines: ["North Indian", "Punjabi", "Indian", "Vegan"],
...

    {
        ...
        data: {
            ...
            name: "EatFit",
            avgRating: 4.5,
            cuisines: ["Chinese", "Healthy Food", "Tandoor", "Vegan"],
...

    {
        ...
        data: {
            ...
            name: "KFC",
            avgRating: 3.8,
            cuisines: ["Chicken", "American", "Sandwich"],
...

    {
        ...
        data: {
            ...
            name: "McDonald's",
            avgRating: 4,
            cuisines: ["American", "Hamburguers", "Nuggets", "Ice cream"],
            deliveryTime: "Delivered in 28 minutes",
            costForTwo: 4000,
